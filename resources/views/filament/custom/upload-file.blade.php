...
<div>
    <form wire:submit='save' class="w-full max-w-sm flex mt-2">
        <div class="mb-4">
            <label for="block text-gray-700 text-sm font-bold mb-2" for="fileInput">
                Pilih Berkas
            </label>
        ...
        <div class="flex items-center justify-between mt-3">
            <button class="text-white font-bold py-2 px-4 rounded focus:outline-none " type="submit">Upload</button>
        </div>
    </form>
</div>